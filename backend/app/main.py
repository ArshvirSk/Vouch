...
from app.routers import commitments, evidence, votes, users, admin, notifications, reports, jury_pool, auth, sources, dao, milestones, area, verdict_history
...
app.include_router(verdict_history.router)
